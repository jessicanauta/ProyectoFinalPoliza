...
a persistence unit "ProyectoFinalPolizaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ProyectoFinalPoliza\pom.xml":
...
artifact ("ProyectoFinalPoliza.war") is already built. You can build
